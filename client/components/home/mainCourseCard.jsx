  ...
  return (
    ...
    <div className='border-[#079C49] rounded-[22.42px] border-2 p-[11.66px] md:pb-[27px] hover:bg-[#f1f1f1] cursor-pointer w-[320px] md:w-[30%]  md:mb-0'>
       ...
       objectFit="cover"/>
        ...
        <h5 className='text-[#1F1F1F] text-[17px] leading-[22px] sm:text-[22px] font-[600] mt-[27px] sm:leading-[28px] md:max-w-[379px]'>Introduction to administrative guide</h5>
        <div className='mt-[20px] sm:mt-[30px]'>
            <div className="flex items-center">
                <Image src="/icons/time.svg" width={22} height={25}/>
                <h6 className='text-[16px] sm:text-[20px] text-[#1F1F1F] ml-2'>15 hours</h6>
            </div>
            <div className="flex items-center mt-[15px]">
                <Image src="/icons/certf.svg" width={22} height={25}/>
                <h6 className='text-[16px] sm:text-[20px] text-[#1F1F1F] ml-2'>Certificated</h6>
            </div>
        </div>
    </div>
  )
