              ...
              <div className="col-span-2">
                  ...
                  <div className="bg-[#fff] p-4 rounded-[15px] ">
                     ...
                     <div className="grid grid-cols-3 gap-4 my-4">
                         ...
                         {upcoming[0]? <CourseCard name ={upcoming[0].name} descrip="Lesson 6" icon="/icons/courseIcon.svg" />: null}
                         {upcoming[1]? <CourseCard name ={upcoming[1].name} descrip="Lesson 6" icon="/icons/courseIcon.svg" />: null}
                         {upcoming[2]? <CourseCard name ={upcoming[2].name} descrip="Lesson 6" icon="/icons/courseIcon.svg" />: null}
